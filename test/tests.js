...
describe('Collect.js Test Suite', function () {
  ...
  it('should return the all combinations of the items of the collection', function () {
    expect(collect(['1', '2']).combinations()).to.eql([['1','1'], ['1','2'], ['2', '1'], ['2', '2']])
    expect(collect(['1', '2', '3']).combinations()).to.eql([['1','1','1'], ['1','1','2'], ['1','1','3'], ['1','2','1'], ['1','2','2'], ['1','2','3'], ['1','3','1'], ['1','3','2'], ['1','3','3'], ['2','1','1'], ['2','1','2'], ['2','1','3'], ['2','2','1'], ['2','2','2'], ['2','2','3'], ['2','3','1'], ['2','3','2'], ['2','3','3'], ['3','1','1'], ['3','1','2'], ['3','1','3'], ['3','2','1'], ['3','2','2'], ['3','2','3'], ['3','3','1'], ['3','3','2'], ['3','3','3']])
  });
});
