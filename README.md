...
In addition to the above methods, the underlying `Collection` class is also exported and can be used to extend `collect.js` as well as check for the correct type in your application code or tests.
